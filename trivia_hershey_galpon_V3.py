        ...
        if 0 <= index < len(opciones):
            ...
            if index < len(self.botones_canvas):
                ...
                if btn_info["tipo"] == "rectangle":
                    ...
                    # Si es una imagen personalizada: Podemos añadir un rectángulo dorado resplandeciente justo detrás de ella
                    ...
                    if bbox:
                        ...
                        # Lo enviamos al fondo respecto a la imagen para que actúe como borde exterior
