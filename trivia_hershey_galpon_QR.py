...
class HersheysTriviaApp:
    ...
    def obtener_qr_instagram(self, url="https://www.instagram.com/integra3d?stkn=c3l5ZWhzaWdsemZw"):
        qr = qrcode.QRCode(
            version=None,
...
# ==========================================        
    ...
    # ==========================================
    # PANTALLA 3: CODIGO QR instagram https://www.instagram.com/integra3d?stkn=c3l5ZWhzaWdsemZw
    # ==========================================
    def generar_qr_tk(self, url="https://www.instagram.com/tu_cuenta"):
        """Genera una imagen ImageTk de un código QR para Tkinter."""
        qr = qrcode.QRCode(
            version=1,
            error_correction=qrcode.constants.ERROR_CORRECT_L,
            box_size=8,
    ...
    # ==========================================
    # PANTALLA 3: REGISTRO / RESULTADOS Y QR INSTAGRAM
    # ==========================================
    def mostrar_formulario_registro(self):
        ...
        # --- SECCIÓN DE RESULTADO OBTENIDO EN LA TRIVIA ---
        # (Asegúrate de que self.puntaje tenga las respuestas correctas acumuladas)
        puntaje_obtenido = getattr(self, "puntaje", 0)
        total_preguntas = getattr(self, "total_preguntas", 3)
        
        # Clasificación personalizada según el puntaje
        if puntaje_obtenido == total_preguntas:
            nivel = "🏆 ¡Hershey's Lover Experto!"
        elif puntaje_obtenido > 0:
            nivel = "🍫 ¡Aficionado al Chocolate!"
        else:
            nivel = "✨ ¡Fan en Proceso!"

        lbl_resultado = tk.Label(
            center_frame,
            text=f"Tu Resultado: {puntaje_obtenido}/{total_preguntas} Aciertos\n{nivel}",
        ...
        subtitle = tk.Label(
            center_frame,
            text="Escanea el código QR para seguir nuestra cuenta\ny validar tu participación:",
            font=("Helvetica", 15),
            bg=BG_DARK_CARD,
            fg=TEXT_DARK_WHITE,
            justify="center",
       ...
       # center_frame,
       #    text=f"⏱️ Avanzando en {self.tiempo_restante_registro}s...",
       ...
       #self.lbl_timer_registro.pack(pady=(0, 5))
        ...
        self.img_qr_tk = self.obtener_qr_instagram()
    ...
    def reiniciar_timer_registro(self, event=None):
        self.tiempo_restante_registro = 25
        if (
